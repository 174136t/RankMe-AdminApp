...
var kPrimaryColor = Color(0xffFC9535);
...
const greenColor1 = Color(0xFF388E3C);
const greenColor2 = Color(0xFFC8E6C9);
...
const redGradient = LinearGradient(
  colors: <Color>[kCategoryTextColor, kBlueColor],
  stops: [0.0, 1.0],
  begin: Alignment.topCenter,
  end: Alignment.bottomCenter,
);
...
const greenGradient = LinearGradient(
  colors: <Color>[greenColor, greenColor1, greenColor2],
  stops: [0.0, 0.3,1.0],
...
var bluePinkGradient = new LinearGradient(
  colors: [const Color(0xFF6600FF),const Color(0xFFCC0099)],
  tileMode: TileMode.clamp,
  begin: Alignment.bottomLeft,
  end:Alignment.topRight,
  stops: [0.0,1.0]
);
var bluePinkGradient2 = new LinearGradient(
  colors: [const Color(0xFFCC0099),const Color(0xFFCE93D8)],
  tileMode: TileMode.clamp,
  begin: Alignment.bottomLeft,
  end:Alignment.topRight,
  stops: [0.0,1.0]
...
var pinkRedGradient = new LinearGradient(
  colors: [const Color(0xFFCE93D8),const Color(0xFFFF3399)],
  tileMode: TileMode.clamp,
  end: Alignment.topRight,
  begin:Alignment.bottomLeft,
  stops:[0.0,1.0]
...
var redSexyGradient = new LinearGradient(
  colors: [const Color(0xFFFF3399),const Color(0xFFFF5F6d)],
  tileMode: TileMode.clamp,
  begin: Alignment.bottomLeft,
  end: Alignment.topRight,
  stops: [0.0,1.0]
...
var orangeCoral2 = new LinearGradient(
  colors: [const Color(0xFFff5e62),const Color(0xFFFF8F00)],
  tileMode: TileMode.clamp,
  begin: Alignment.bottomLeft,
  end: Alignment.topRight,
  stops: [0.0,1.0]
